...
const messages = {
  App: {
    title: ['제목', 'Title', 'JP-Title', 'ZH-Title', 'FR-Title', 'ES-Title'],
    login: ['로그인', 'Log in', 'JP-Log in', 'ZH-Log in', 'FR-Log in', 'ES-Log in'],
    logout: ['로그아웃', 'Log out', 'JP-Log out', 'ZH-Log out', 'FR-Log out', 'ES-Log out'],
    menu1: ['메뉴 1', 'Menu 1', 'JP-Menu 1', 'ZH-Menu 1', 'FR-Menu 1', 'ES-Menu 1'],
    menu2: ['메뉴 2', 'Menu 2', 'JP-Menu 2', 'ZH-Menu 2', 'FR-Menu 2', 'ES-Menu 2'],
    singup: ['가입하기', 'Sign Up', 'JP-Sign Up', 'ZH-Sign Up', 'FR-Sign Up', 'ES-Sign Up']
  }
};
        ...
        <div className={classes.appFrame}>
          <AppBar className={classes.appBar}>
            <Toolbar>
              ...
              {cookies.get('access_token') ? (
                <Button color="contrast" onClick={this.handleSignOut}>
                  {translate('App.logout')}
                </Button>
              ) : (
                <Button color="contrast" onClick={this.handleSignin}>
                  {translate('App.login')}
                </Button>
              )}
            </Toolbar>
